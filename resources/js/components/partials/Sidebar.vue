<template>
    ...
    <div class="app-branding">
        <router-link class="app-logo" :to="{ name: 'Index' }">
        ...
        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
            ...
            <li class="nav-item has-submenu">
                <a class="nav-link submenu-toggle collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-2" aria-expanded="false" aria-controls="submenu-2">
                    ...
                    <span class="nav-link-text">Validaciones</span>
                    <span class="submenu-arrow">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"></path>
                        </svg>
            ...
            <li class="nav-item has-submenu">
                <a class="nav-link submenu-toggle collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-5" aria-expanded="false" aria-controls="submenu-5">
                    <span class="nav-icon">
                ...
                <div id="submenu-5" class="submenu submenu-5 collapse" data-bs-parent="#menu-accordion" style="">
                    <ul class="submenu-list list-unstyled">
                        <li class="submenu-item">
                            <a class="submenu-link" href="#">Facturas</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="nav-item has-submenu">
                <a class="nav-link submenu-toggle collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-6" aria-expanded="false" aria-controls="submenu-6">
                    <span class="nav-icon">
                ...
                <div id="submenu-6" class="submenu submenu-6 collapse" data-bs-parent="#menu-accordion" style="">
                    <ul class="submenu-list list-unstyled">
                        <li class="submenu-item">
                            <a class="submenu-link" href="#">Empresas</a>
                        </li>
                        <li class="submenu-item">
                            <a class="submenu-link" href="#">Gerencias</a>
                        </li>
                        <li class="submenu-item">
                            <a class="submenu-link" href="#">Proyectos</a>
                        </li>
                        <li class="submenu-item">
                            <a class="submenu-link" href="#">Encargados</a>
                        </li>
                        <li class="submenu-item">
                            <a class="submenu-link" href="#">Áreas</a>
                        </li>
                    </ul>
                </div>
            </li>
